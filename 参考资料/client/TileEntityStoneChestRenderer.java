...
import example.examplemod.blocks.BlockStoneChest;
import example.examplemod.blocks.EnumStoneChest;
import example.examplemod.tileentities.TileEntityStoneChest;
...
public class TileEntityStoneChestRenderer extends TileEntitySpecialRenderer<TileEntityStoneChest> {
    ...
    static {
        for (EnumStoneChest type : EnumStoneChest.values()) {
            normals[type.ordinal()] = new ResourceLocation(MyMod.MODID, "textures/entity/" + type.name().toLowerCase() + ".png");
            doubles[type.ordinal()] = new ResourceLocation(MyMod.MODID, "textures/entity/" + type.name().toLowerCase() + "_double.png");
        }
    }
